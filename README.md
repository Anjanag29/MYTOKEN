...
This is a Solidity smart contract that implements a basic token called MyToken (SPW) with functionalities for minting and burning tokens.
...
1. tokenName: A public variable that represents the name of the token. In this contract, it is set to "SPARROW".
2. tokenAbbrv: A public variable that represents the abbreviation of the token. In this contract, it is set to "SPW".
